 ...
 * object created it. On the top of hierarchy is an instance of WIBrowser as
 * root object. There are many instances of WIBrowser can be created and each
 * one contains own independent hierarchy of WI objects.
 */
