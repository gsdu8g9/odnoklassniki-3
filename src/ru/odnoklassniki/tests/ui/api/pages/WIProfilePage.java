...
public class WIProfilePage extends WIPage {
	...
	public final WIMenuItem mnuPersonalInfo = WIMenuItem.Link(this, Text.LINK_EDIT_PROFILE);
    ...
    public void setPersonalInfo(String aName, String aSurname, String aBirthdate, String aCity, String aBithCity) {
